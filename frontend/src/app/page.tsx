...
export default async function Home() {
    // TODO: separate sections into components(organisms, molecules, atoms)
    return (
        <div className="flex flex-col gap-8 py-16">
            <div className="grid grid-cols-2 w-full h-96 border border-brand-neutral-500 rounded-lg">
                ...
                <div className="col-start-2 flex flex-col items-center pt-10 gap-4">
                    ...
                    <Text className="line-clamp-3">
                        ...
                        Assumenda delectus eligendi reiciendis sed tenetur. Consectetur, delectus deleniti deserunt
                        dolorum excepturi facere iste itaque mollitia, qui reiciendis repellendus rerum tempora vero.
                    </Text>
                    <Link
                        href="/luroa/about"
            ...
            <div className="border border-brand-neutral-500 rounded-md p-4">
                <Text>Key Details section</Text>
            </div>
            <div className="border border-brand-neutral-500 rounded-md p-4">
                <Text>Website sections links</Text>
            </div>
            <div className="flex flex-row gap-8">
                <div className="flex flex-col flex-1 border border-brand-neutral-500 rounded-md p-4">
