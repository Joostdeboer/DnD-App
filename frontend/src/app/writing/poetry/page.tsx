...
export default async function Poetry({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
    ...
    return (
        <PageLayout>
            <Heading>List of Poetry</Heading>
            <ListingPage products={writing} href="/writing/poetry/" />
        </PageLayout>
    );
}
