...
export default async function Stories({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
    ...
    return (
        <PageLayout>
            <Heading>List of Stories</Heading>
            <ListingPage products={writing} href="/writing/stories/" />
        </PageLayout>
    );
}
